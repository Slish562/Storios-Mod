...
public class CutscenePathRenderer {
    ...
    public static void register() {
        MinecraftForge.EVENT_BUS.register(CutscenePathRenderer.class);
    }
    ...
    private static void renderPoint(Matrix4f matrix, CutscenePoint point, boolean selected) {
        ...
        buf.vertex(matrix, x - size, y - size, z - size).color(r, g, b, a).endVertex();
        buf.vertex(matrix, x + size, y - size, z - size).color(r, g, b, a).endVertex();
        buf.vertex(matrix, x + size, y + size, z - size).color(r, g, b, a).endVertex();
        buf.vertex(matrix, x - size, y + size, z - size).color(r, g, b, a).endVertex();
    ...
    private static void renderDirectionArrow(Matrix4f matrix, CutscenePoint point, boolean selected) {
        ...
        buf.vertex(matrix, x, y, z).color(r, g, b, 1.0f).endVertex();
        buf.vertex(matrix, endX, endY, endZ).color(r, g, b, 1.0f).endVertex();
        tess.end();
    }
    ...
    private static void renderPath(Matrix4f matrix, CutsceneTimeline timeline) {
        ...
        for (int i = 0; i < steps; i++) {
            ...
            buf.vertex(matrix, (float) pos1.x, (float) pos1.y, (float) pos1.z).color(r, g, b, 0.9f).endVertex();
            buf.vertex(matrix, (float) pos2.x, (float) pos2.y, (float) pos2.z).color(r, g, b, 0.9f).endVertex();
        }
    ...
    private static void renderGizmoArrow(Matrix4f matrix, float ox, float oy, float oz,
        ...
        if (Math.abs(dx) > 0.001f) {
            ...
            buf.vertex(matrix, ox, oy - thickness, oz - thickness).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex, oy - thickness, oz - thickness).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex, oy - thickness, oz + thickness).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ox, oy - thickness, oz + thickness).color(r, g, b, alpha).endVertex();
            ...
            buf.vertex(matrix, ox - thickness, oy, oz - thickness).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ox - thickness, ey, oz - thickness).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ox - thickness, ey, oz + thickness).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ox - thickness, oy, oz + thickness).color(r, g, b, alpha).endVertex();
            ...
            buf.vertex(matrix, ox - thickness, oy - thickness, oz).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ox - thickness, oy - thickness, ez).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ox - thickness, oy + thickness, ez).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ox - thickness, oy + thickness, oz).color(r, g, b, alpha).endVertex();
        ...
        if (Math.abs(dx) > 0.001f) {
            ...
            buf.vertex(matrix, tx, ty, tz).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex, ey - tipR, ez - tipR).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex, ey + tipR, ez - tipR).color(r, g, b, alpha).endVertex();
            ...
            buf.vertex(matrix, tx, ty, tz).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex - tipR, ey, ez - tipR).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex + tipR, ey, ez - tipR).color(r, g, b, alpha).endVertex();
            ...
            buf.vertex(matrix, tx, ty, tz).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex - tipR, ey - tipR, ez).color(r, g, b, alpha).endVertex();
            buf.vertex(matrix, ex + tipR, ey - tipR, ez).color(r, g, b, alpha).endVertex();
