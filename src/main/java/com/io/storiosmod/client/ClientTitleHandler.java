...
public class ClientTitleHandler {
    ...
    public static void register() {
        NeoForge.EVENT_BUS.register(ClientTitleHandler.class);
    }
    ...
    public static void onRenderGui(RenderGuiLayerEvent.Post event) {
        if (event.getName().equals(VanillaGuiLayers.HOTBAR) && displayTicks > 0 && currentMessage != null) {
            renderTitle(event.getGuiGraphics(), event.getGuiGraphics().guiWidth(),
