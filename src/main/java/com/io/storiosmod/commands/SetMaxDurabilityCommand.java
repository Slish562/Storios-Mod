...
public class SetMaxDurabilityCommand {
    ...
    private static int execute(CommandContext<CommandSourceStack> context) {
        try {
            ...
            net.minecraft.world.item.component.CustomData.update(net.minecraft.core.component.DataComponents.CUSTOM_DATA, item, tag -> tag.putInt("storiosmod:max_damage", amount));
