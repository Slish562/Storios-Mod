...
public class CoolerBlock extends Block {
    ...
    protected ItemInteractionResult useItemOn(ItemStack stack, BlockState state, Level level, BlockPos pos, Player player, InteractionHand hand, BlockHitResult hit) {
        ...
        if (isGlassBottle) {
            filledBottle = net.minecraft.world.item.alchemy.PotionContents.createItemStack(Items.POTION, Potions.WATER);
        } else {
            filledBottle = new ItemStack(ItemRegistry.REUSABLE_BOTTLE.get());
        }

        net.minecraft.world.item.component.CustomData.update(net.minecraft.core.component.DataComponents.CUSTOM_DATA, filledBottle, tag -> {
