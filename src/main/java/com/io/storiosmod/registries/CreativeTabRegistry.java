...
public class CreativeTabRegistry {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> EQUIPMENT_TAB = TABS.register("story_items",
            () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup." + StoriosMod.MODID + ".story_items_tab"))
                    .icon(() -> new ItemStack(ItemRegistry.MYTHRIL.get()))
                    .displayItems((enabledFeatures, entries) -> {
                        ...
                        if (WastelandModule.ENABLED) {
                            ...
                            entries.accept(ItemRegistry.REUSABLE_BOTTLE_EMPTY.get());
                            entries.accept(ItemRegistry.REUSABLE_BOTTLE.get());
                            entries.accept(ItemRegistry.COOLER_ITEM.get());
                        }


                        entries.accept(ItemRegistry.RADIUS_TRIGGER_ITEM.get());
